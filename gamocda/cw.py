...
#%---nashtis gamotvlas nishnavs  print(12%3)
#//----mtel gayopas nishnavs (tu nashtiani gayopaa mtel ricxvs anu nashtis gareshe abrunebs)   print(10//6)
#**------nishnavs xarisxshi ayvanas print(15**2)---anu 15 x 15





         #  7   MESHVIDES PASUXEBI

#7)მომხმარებელს შემოატანინე ორი რიცხვიდ ა მოახდინე აბსოლიტურად ყველა ამთემატიკური მოქმედება ამ ორ რიცხვზე --> + - * / // ** %


name11=int(input("write: "))
name22=int(input("write: "))
...
#str()----es aris python punqcia romelic ricxvs booleans an sxva tips text-ad achvenebs(string-ad gardakmnis)------------

#int()----es aris python punqcia romelic mnishvnelo9bas gadaakcevs mtel ricxvad-----------
asaki="23"
print("axalgazrda",int(asaki))


#float()-----es aris python punqcia romelic ricxvs akcevs wiladad------------ 
x2=5
p3=float(x2)  
print(p3)
...
borshi=int(input("write: "))
soup=int(input("write: "))
...
#logikuri gamnoiyeneba boolean gamotvlebshi and,or
#or------- an erti wesmariti 
#and-------da orive wsmariti unda iyos
...
tuy=["kopa","lopa","tropa","tripa","gopa"]
for tuy in tuy :
    print(tuy)
...
names34=["გოგა" , "ირაკლი" , "საბა" , "გიორგი" , "ირმა" , "იამზე"]
...
kopex="ჰიდროელექტროსადგური"
print(kopex[3]), (kopex[8])     #-14
print(kopex[-18]),(kopex[-5])   #7
...
namesss=["temo","koba","toma","lasha","aleksi","gio"]

if namesss[2] == "lasha":
    print("you choosed lasha")
elif namesss[5] == "gio":
    print("you choosed gio")
                ...
                #    26    OCDAMEEKVSES PASUXEBI

#26)შექმენი ცვლადი სადაც შეინახავ პაროლს მომხმარებელს შემოატანინე პაროლი სანამ პირობა არის ჭეშმარიტი(True) თუ მომხმარებლის პაროლი დაემთხვა შენს პაროლს: დაპრინტე --> გამოიცანი break სხვა შემთხვევაში: თავიდან გაუმეორე რომ შემოიყვანოს პაროლი
...
if kolip == jio:
    ...
    print("try again")
                ...
                #  27  OCDAMESHVIDES PASUXEBI

#27)შექმენი ცვლადი და შეინახე სტრინგი --> " , შენი დავალებაა რომ ტერმინალში გამოიტანო სადგური ,გამოიყენე slicing, ასევე კიდევ გამოიტანე ელექტროსადგური აქაც გამოიყენე სლაისინგი

tropaa="ჰიდროელექტროსადგური"
...
mimic=["გოგა" , "ირაკლი" , "საბა" , "გიორგი" , "ირმა" , "იამზე" , "სანი" , "თენგო" , "ლიზი" , "ნუცა" , "ქეთებვანი"]
print(mimic[2:7])
print(mimic[0:4])
...
if p[0] > p[2] and p[0] > 0:                                  
    print("good")  
elif p[0] < p[2] and p[2] < 0: 
    print("bad")     
else:
    print("get out")                                                                                               
...
if nummm > 10 and nummm < 30:                                  
    print("You entered number between 10 and 30")  
elif nummm < 10 and nummm > 0: 
...
kolia=["koko","loko","moko","doko"]

if kolia[0] == "luka" or kolia[0] == "saba":
    print("You choose luka or saba") 
elif kolia[0] == "irma" or kolia[0] == "iamze":
    print("You choose irma or iamze")
else:
    print("you chouse a nother name")